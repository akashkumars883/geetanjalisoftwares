...
export default function Hero() {
  return (
    <section className="relative w-full min-h-[85vh] md:min-h-[90vh] overflow-hidden bg-white flex items-center justify-center text-center px-6 pt-28 pb-16 md:pt-20 md:pb-12">
      {/* Background Video */}
      <video
        autoPlay
        loop
