          ...
          {steps.map((step, index) => (
            <div key={step.title} className="group relative">
              ...
              {index < steps.length - 1 && (
                <div className="absolute left-1/2 top-16 hidden h-0.5 w-full bg-gradient-to-r from-slate-200 to-transparent md:block" />
              )}
              ...
              <div className="relative flex flex-col items-center text-center">
                ...
                {/* Step Number */}
                <div className="mt-4 flex h-8 w-8 items-center justify-center rounded-full bg-blue-100 text-sm font-bold text-blue-600">
                  {index + 1}
                </div>
