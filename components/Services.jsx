        ...
        <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div className="max-w-2xl">
            ...
            <p className="mt-4 text-sm leading-7 text-black/70 sm:text-base">
              ...
              everything so you can focus on you business.{" "}
            </p>
          </div>

          <Link
            href="/services"
            className="inline-flex w-full items-center justify-center rounded-full border border-black/15 bg-white/80 px-6 py-3 text-sm font-semibold text-black transition hover:bg-black/5 sm:w-auto"
          >
            View All Services
          </Link>
        </div>
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-3">
          {services
            ...
            <article
              id={service.slug}
              key={service.slug}
              className="group relative scroll-mt-28 overflow-hidden rounded-[28px] border border-black/10 bg-white/80 p-5 shadow-[0_24px_60px_-40px_rgba(0,0,0,0.45)] backdrop-blur-xl transition duration-300 hover:-translate-y-1 hover:shadow-[0_32px_70px_-36px_rgba(0,0,0,0.4)] sm:p-6"
            >
