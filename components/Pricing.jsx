      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
          {plans.map((plan, index) => (
            <article
              key={index}
              className={`rounded-2xl p-8 flex flex-col justify-between border transition-all duration-300 ${plan.featured
            ...
            >
              ...
              <div className="pt-8">
                <Link
                  href="/contact"
                  className={`w-full inline-flex items-center justify-center gap-2 py-3.5 px-6 rounded-full text-xs font-bold uppercase tracking-wider transition-all duration-200 ${plan.featured
