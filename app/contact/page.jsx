    ...
    <main className="min-h-screen bg-white pt-16 text-left">
      ...
      <section className="py-10 bg-white px-6">
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12">
          ...
          <div className="lg:col-span-5 space-y-8">
            ...
            <div className="space-y-4">
              {contactDetails.map((item, i) => (
                <div key={i} className="flex items-center gap-4 p-4 bg-stone-50 border border-stone-100 rounded-xl">
                  <div className="h-9 w-9 rounded-lg bg-white border border-stone-100 flex items-center justify-center shrink-0">
                    {item.icon}
                  </div>
                  <div>
            ...
            <div className="p-6 rounded-xl bg-stone-50 border border-stone-100 space-y-4">
              ...
              <div className="flex flex-wrap items-center gap-3">
                ...
                <a
                  ...
                  aria-label="Facebook"
                  className="inline-flex items-center gap-2 px-3.5 py-2 rounded-full bg-white border border-stone-200 text-xs font-semibold text-stone-700 hover:text-orange-600 hover:border-orange-200 transition-all shadow-sm"
                >
          ...
          {/* Contact Form */}
          <div className="lg:col-span-7 bg-stone-50 border border-stone-100 rounded-xl p-6 sm:p-8 space-y-5">
