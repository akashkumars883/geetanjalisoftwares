...
export async function generateMetadata({ params }) {
  ...
  return {
    ...
    alternates: {
      canonical: `https://geetanjalisoftwares.com/case-studies/${project.slug}`,
    },
    openGraph: {
      title: project.title,
      description: project.summary,
      url: `https://geetanjalisoftwares.com/case-studies/${project.slug}`,
      type: "article",
    },
  };
}
    ...
    <main className="min-h-screen bg-white pt-16 pb-20 text-left selection:bg-orange-500/20 selection:text-orange-900">
      ...
      <div className="max-w-5xl mx-auto px-6 space-y-12">
        ...
        <header className="space-y-6 border-b border-stone-200 pb-10">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 p-6 rounded-md bg-stone-50 border border-stone-200">
            <div>
