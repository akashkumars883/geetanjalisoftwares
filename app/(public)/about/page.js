    ...
    <div className="pt-0">
      <section className="relative pb-16 pt-4 sm:pb-24 sm:pt-8">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="mt-6 text-4xl font-bold tracking-tight text-black sm:text-5xl lg:text-7xl">
            Helping businesses build a <br className="hidden sm:block" /> 
            <span className="text-black/60">confident digital presence.</span>
          </h1>
          <p className="mx-auto mt-8 max-w-2xl text-base leading-8 text-black/70 sm:text-lg">
      ...
      <section className="pb-16 sm:pb-24">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div className="relative aspect-square overflow-hidden rounded-[40px] bg-stone-100 border border-black/5">
            ...
            <div className="max-w-xl">
              ...
              <div className="mt-10 grid gap-6 sm:grid-cols-2">
                <div className="rounded-2xl border border-black/5 bg-[#f5f5f5]/50 p-6">
